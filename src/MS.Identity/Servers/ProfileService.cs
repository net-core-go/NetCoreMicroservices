...
namespace MS.Identity.Servers
{
    public class CustomProfileService : IProfileService
    {
        ...
        /// The users
        /// </summary>
        protected readonly IUserStore Users;
        ...
        public CustomProfileService(IUserStore users, ILogger<CustomProfileService> logger)
        {
            Users = users;
            Logger = logger;
        }
        ...
        public virtual async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            if (context.RequestedClaimTypes.Any())
            {
                ...
                if (user != null)
                {
                    ...
                    context.IssuedClaims = user.IdentityClaims.ToList();
                }
            }
